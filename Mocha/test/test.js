...
describe('Test Event table Properties:', function () {
    ...
    before(function (done) {
        chai.request("https://globalcal5.azurewebsites.net")
            .get("/app/event/")
...
describe('table contents:', function () {
    ...
    it('Expected results for event id 1', function () {
        ...
        expect(requestResult["startDate"]).to.equal("2021-03-13T00:00:00.000Z");
        expect(requestResult["endDate"]).to.equal('2021-03-13T00:00:00.000Z');
...
describe('Post and DELETE API Test : ', function () {
    ...
    it('GET Event 100 expexted Null', function () {
        chai.request("https://globalcal5.azurewebsites.net")
            .get("/app/event/100")
            .end(function (err, res) {
                requestResult = res.body;
    ...
    it('GET Event 100', function () {
        chai.request("https://globalcal5.azurewebsites.net")
            ...
            .end(function (err, res) {
                ...
                expect(err).to.be.null;
                expect(res).to.have.status(200);
                expect(requestResult["eventId"]).to.equal(100);
